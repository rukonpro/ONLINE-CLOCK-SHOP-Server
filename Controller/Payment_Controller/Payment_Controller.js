...
module.exports.paymentInit = async (req, res) => {
    try {
        ...
        const data = {
            ...
            success_url: 'https://evening-woodland-47343.herokuapp.com/api/v1/payment/success',
            fail_url: 'https://evening-woodland-47343.herokuapp.com/api/v1/payment/fail',
            cancel_url: 'https://evening-woodland-47343.herokuapp.com/api/v1/payment/cancel',
            ipn_url: 'https://evening-woodland-47343.herokuapp.com/api/v1/payment/ipn',
